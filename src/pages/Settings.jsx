    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className="font-semibold text-stone-800 text-sm">Privacy Policy</p>
            <p className="text-xs text-stone-500 mt-0.5">How we handle your data and your rights</p>
          </div>
          <svg className="w-4 h-4 text-stone-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
        </Link>
        ...
        >
          <div className="w-10 h-10 rounded-xl bg-stone-100 flex items-center justify-center flex-shrink-0">
            <svg className="w-5 h-5 text-stone-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
          </div>
          <div className="flex-1 min-w-0">
            <p className="font-semibold text-stone-800 text-sm">Terms of Service</p>
            <p className="text-xs text-stone-500 mt-0.5">Rules, rights, and limitations of use</p>
          </div>
          <svg className="w-4 h-4 text-stone-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
        </Link>
