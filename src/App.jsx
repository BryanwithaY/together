...
const AuthenticatedApp = () => {
  ...
  // Render the main app
  // RelationshipProvider wraps all routes here (not inside Layout) so its state
  // persists across navigation instead of remounting/refetching on every page change.
  return (
